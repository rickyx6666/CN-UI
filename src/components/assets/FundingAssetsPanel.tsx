...
interface FundingAssetsPanelProps {
  onCoinClick: (symbol: string) => void
}

export function FundingAssetsPanel({ onCoinClick }: FundingAssetsPanelProps) {
  return (
    <>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-caption text-secondary">{coin.chainLabel}</p>
                </div>
              </div>
