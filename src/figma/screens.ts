...
const walletScreens: MobileScreenDef[] = [
  ...
  {
    path: 'wallet/security-verify-single',
    label: '安全验证 · 单因子',
    description: 'Google / 邮箱 / 手机任选其一',
    group: 'wallet',
    preset: app({
      isLoggedIn: true,
      activeTab: 'assets',
      userGoogleAuthBound: true,
      userPhoneBound: true,
      securityVerifyScenario: 'single',
      walletScreen: { screen: 'withdraw-security-verify', coin: 'USDT', chain: 'TRC20' },
      withdrawDraft: mockWithdrawDraft,
    }),
  },
  {
    path: 'wallet/security-verify-google-email',
    label: '安全验证 · Google + 邮箱',
    description: '同时验证身份验证器与邮箱',
    group: 'wallet',
    preset: app({
      isLoggedIn: true,
      activeTab: 'assets',
      userGoogleAuthBound: true,
      securityVerifyScenario: 'google-email',
      walletScreen: { screen: 'withdraw-security-verify', coin: 'USDT', chain: 'TRC20' },
      withdrawDraft: mockWithdrawDraft,
    }),
  },
  {
    path: 'wallet/security-verify-google-contact',
    label: '安全验证 · Google + 邮箱/手机',
    description: '身份验证器 + 邮箱或手机二选一',
    group: 'wallet',
    preset: app({
      isLoggedIn: true,
      activeTab: 'assets',
      userGoogleAuthBound: true,
      userPhoneBound: true,
      securityVerifyScenario: 'google-contact',
      walletScreen: { screen: 'withdraw-security-verify', coin: 'USDT', chain: 'TRC20' },
      withdrawDraft: mockWithdrawDraft,
    }),
  },
  {
    path: 'wallet/security-verify-contact',
    label: '安全验证 · 邮箱/手机',
    description: '邮箱或手机任选其一',
    group: 'wallet',
    preset: app({
      isLoggedIn: true,
      activeTab: 'assets',
      userPhoneBound: true,
      securityVerifyScenario: 'contact',
      walletScreen: { screen: 'withdraw-security-verify', coin: 'USDT', chain: 'TRC20' },
      withdrawDraft: mockWithdrawDraft,
    }),
  },
  {
    path: 'wallet/security-verify-email-phone',
    label: '安全验证 · 邮箱 + 手机',
    description: '同时验证邮箱与手机',
    group: 'wallet',
    preset: app({
      isLoggedIn: true,
      activeTab: 'assets',
      userPhoneBound: true,
      securityVerifyScenario: 'email-phone',
      walletScreen: { screen: 'withdraw-security-verify', coin: 'USDT', chain: 'TRC20' },
      withdrawDraft: mockWithdrawDraft,
    }),
  },
  {
    path: 'wallet/security-verify-google-email-phone',
    label: '安全验证 · Google + 邮箱 + 手机',
    description: '同时验证身份验证器、邮箱与手机',
    group: 'wallet',
    preset: app({
      isLoggedIn: true,
      activeTab: 'assets',
      userGoogleAuthBound: true,
      userPhoneBound: true,
      securityVerifyScenario: 'google-email-phone',
      walletScreen: { screen: 'withdraw-security-verify', coin: 'USDT', chain: 'TRC20' },
      withdrawDraft: mockWithdrawDraft,
    }),
  },
...
const pcScreens: FigmaScreenEntry[] = [
  ...
  {
    path: 'pc/wallet/security-verify-single',
    label: 'PC · 安全验证 · 单因子',
    group: 'pc',
    preset: pc({
      isLoggedIn: true,
  ...
  {
    path: 'pc/wallet/security-verify-google-email',
    label: 'PC · 安全验证 · Google + 邮箱',
    group: 'pc',
    preset: pc({
      isLoggedIn: true,
      activeTab: 'assets',
  ...
  {
    path: 'pc/wallet/security-verify-google-contact',
    label: 'PC · 安全验证 · Google + 邮箱/手机',
    group: 'pc',
    preset: pc({
      isLoggedIn: true,
      activeTab: 'assets',
  ...
  {
    path: 'pc/wallet/security-verify-contact',
    label: 'PC · 安全验证 · 邮箱/手机',
    group: 'pc',
    preset: pc({
      isLoggedIn: true,
  ...
  {
    path: 'pc/wallet/security-verify-email-phone',
    label: 'PC · 安全验证 · 邮箱 + 手机',
    group: 'pc',
    preset: pc({
      isLoggedIn: true,
  ...
  {
    path: 'pc/wallet/security-verify-google-email-phone',
    label: 'PC · 安全验证 · Google + 邮箱 + 手机',
    group: 'pc',
    preset: pc({
      isLoggedIn: true,
